...
from blades_sphinx_theme.extension.logo import logo_role

from pyg_sphinx_theme.extension import pyg
...
def monkey_patch_find_autosummary_in_lines(
    ...
    for line in lines:
        if in_autosummary:
            ...
            # Begin of odified part by `blades_sphinx_theme` #####################
            ...
            if m:
                ...
                continue
            # End of modified part by `blades_sphinx_theme` ######################
